...
- [Linux Virsh Subcommands](https://www.redhat.com/en/blog/virsh-subcommands). 8 Virsh subcommands for managing VMs on the command line
- [Python Tips](https://book.pythontips.com/en/latest/#) Free book (Intermediate Python)
- [kifarunix.com](https://kifarunix.com/) Linux system administration, containers, monitoring, security, networking, and storage
- [Containerlab](https://paramountnetworking.com/2022/04/01/containerlab-for-beginners/) Helpful guide to getting started
- [Chirpy Theme](https://chirpy.cotes.page/)
- [Sven van Ginkel](https://svenvg.com/) Homelab Enthusiast, sharing insights on networking, automation, and building reliable systems.
- [Terraform provider for libvirt](https://github.com/dmacvicar/terraform-provider-libvirt)
- [Open-Source Routing and Network Simulation](https://brianlinkletter.com/)
...
- [Andras the Techie](https://dosztal.com/) Network engineer/architect, involved in many other things, father of three
...
- [NetDevOps](https://mayanknauni.com/?cat=4)
